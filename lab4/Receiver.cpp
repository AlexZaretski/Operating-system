...
#include <windows.h>
#include <string>
#include <vector> // Добавили заголовок
...
int main() {
    ...
    std::vector<HANDLE> hEvents(number_of_senders); // Правильное объявление
    ...
    WaitForMultipleObjects(number_of_senders, hEvents.data(), TRUE, INFINITE); // Используем .data() для вектора
